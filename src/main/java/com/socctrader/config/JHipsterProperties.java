...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "socctrader@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "socctrader API";

        private String description = "socctrader API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "socctrader";
